...
#2. create Model
class Gated_Recurrent_Units(nn.Module):
    def __init__(self, input_shape, hidden_size, n_layers, sequence_length, num_classes) -> None:
        super(Gated_Recurrent_Units, self).__init__()
        
        self.hidden_size = hidden_size
        self.n_layers = n_layers
        
        self.GRU = nn.GRU(input_shape, hidden_size, n_layers, batch_first = True)
...
# create NN
model = Gated_Recurrent_Units(input_shape, hidden_size, n_layers, sequence_length, num_classes).to(device)
